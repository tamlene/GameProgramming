  ...
  <section class="about">
    <div class="container about-content">
      <div class="text">
        <h1>Về chúng tôi</h1>
        <p>
          <strong>HomeDecor</strong> là công ty chuyên thiết kế và thi công nội thất với hơn <strong>10 năm kinh
            nghiệm</strong>.
          Chúng tôi luôn hướng đến việc tạo nên những không gian sống hiện đại, tinh tế và phù hợp với từng cá nhân.
        </p>
        <p>
